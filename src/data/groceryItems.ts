export default [
    ...
    { id: 12, name: 'Orange Juice', section: 'Beverages', price: 2.29, weight: 1 }, // 1L
    ...
    { id: 25, name: 'Peanut Butter', section: 'Pantry', price: 3.49, weight: 0.5 }, // 500g
    ...
    { id: 28, name: 'Mayonnaise', section: 'Condiments', price: 2.99, weight: 0.5 },// 500g
    ...
    { id: 37, name: 'Salad Dressing', section: 'Condiments', price: 2.49, weight: 0.3 }, // 300g
    ...
    { id: 44, name: 'Frozen Vegetables', section: 'Frozen', price: 2.99, weight: 1 }, // 1kg
    ...
    { id: 51, name: 'Cottage Cheese', section: 'Dairy', price: 2.79, weight: 0.5 },// 500g
    { id: 52, name: 'Salad Mix', section: 'Produce', price: 2.99, weight: 0.5 }, // 500g
    { id: 53, name: 'Frozen Berries', section: 'Frozen', price: 6.99, weight: 0.5 }, // 500g
    { id: 54, name: 'Canned Beans', section: 'Canned Goods', price: 1.29, weight: 0.5 }, // 500g
    { id: 55, name: 'Coconut Water', section: 'Beverages', price: 2.99, weight: 1 }, // 1L
